bonusesApp.factory('getRepostsCount', function (vkApiService, $q, vkResponseService) {
  var TIMEOUT = {
    RECURSION: 600
  };
  var api = {
  ...
  return {
    ...
    fetchRepostsData: function (groupId, postItemId, repostsSize, streamCount) {
      var log = debug('bonusesApp:fetchRepostsData');
...
//          });
    ...
    fetchPostRepostData: function (wallDataList) {
      var log = debug('bonusesApp:fetchPostRepostData');
...
//          console.log('response', response);
    ...
    fetchRepostsDataLess1k: function (postIdList, streamCount) {
      var log = debug('bonusesApp:fetchRepostsDataLess1k');
      var deferred = $q.defer();
